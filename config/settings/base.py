...
CSP_FORM_ACTION = (
    ...
    # Orbita: eigener X-Provider (providers/x.py), den der Upstream nicht hat.
    "https://twitter.com",
    "https://x.com",
)
...
PLATFORM_CREDENTIALS_FROM_ENV = {
    ...
    # X (Twitter) - OAuth 2.0 with PKCE, Free-Tier-compatible
    "x": {
...
OAUTH2_PROVIDER = {
    "SCOPES": {"mcp": "Call Orbita Social MCP tools on your behalf"},
    "DEFAULT_SCOPES": ["mcp"],
    "PKCE_REQUIRED": True,
