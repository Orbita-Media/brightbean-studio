    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("digest_mode", models.BooleanField(default=False, help_text="Batch email notifications into a daily digest.")),
                ("user", models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="quiet_hours", to=settings.AUTH_USER_MODEL)),
            ],
            options={
